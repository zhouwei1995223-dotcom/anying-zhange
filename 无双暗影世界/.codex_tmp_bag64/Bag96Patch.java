...
public class Bag96Patch {
    static final int BAG_SIZE = 96;
    static final int ROWS = 12;
    static final int HEIGHT = 566;
    ...
    static void patchServer(String root) throws Exception {
        ...
        depot.writeFile(root + "/.codex_tmp_bag64/server_bag96_classes");
    }
    ...
    static void patchClient(String root) throws Exception {
        ...
        heroDepot.writeFile(root + "/.codex_tmp_bag64/client_bag96_classes");
        ...
        CtMethod openBag = bagWindow.getDeclaredMethod("dw");
        openBag.insertAfter(
            "{ " +
            "this.setBounds(232, 40, 232, " + HEIGHT + "); " +
            "this.kZ = new int[" + BAG_SIZE + "][2]; " +
        ...
        bagWindow.writeFile(root + "/.codex_tmp_bag64/client_bag96_classes");
    }
}
