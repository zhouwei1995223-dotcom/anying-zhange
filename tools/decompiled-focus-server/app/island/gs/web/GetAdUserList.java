...
extends WebServlet {
    public String getResponseText(app.a.b b2, GameServer gameServer, o o2) {
        ...
        try {
            ...
            String string5 = "";
            string5 = string4.equals("all") ? "select username,content,time from userlogs where category='userCreated' and TO_DAYS(now())-TO_DAYS(time)<1" : "select username,content,time from userlogs where category='userCreated' and content='" + b.case(string4) + "'";
