...
public class h {
    ...
    public h(String string, int n2) throws IOException {
    ...
    public h(String string, int n2, String string2, int n3) throws IOException {
        this(new Socket(string, n2), string2, n3);
    }

    public h(String string, int n2, String string2, String string3, String string4, int n3) throws IOException {
        this(new Socket(string, n2), string2, string3, string4, n3);
    }

    public h(Socket socket, String string, int n2) throws IOException {
        this.if = socket.getInputStream();
        this.int = socket.getOutputStream();
        this.new = new k(this.if);
        this.do = new g(this.int);
    ...
    public h(Socket socket, String string, String string2, String string3, int n2) throws IOException {
        this.if = socket.getInputStream();
        this.int = socket.getOutputStream();
        this.new = new k(this.if);
        this.do = new g(this.int);
